			...
			<div class="card">
				...
				<form action="${pageContext.request.contextPath}/manage-rooms"
					...
					<input type="text" name="room_furnishing" placeholder="Furnishing"
						...
						name="room_size" placeholder="Size (sq ft)" required /> <select
						name="location_ID" required>
						<c:forEach var="loc" items="${locations}">
							<option value="${loc.location_ID}">${loc.location_city},
								${loc.location_area}</option>
						</c:forEach>
					</select> <select name="price_ID" required>
					...
					<div class="room-entry">
						<form action="${pageContext.request.contextPath}/manage-rooms"
							...
							<input type="hidden" name="room_ID" value="${room.room_ID}" /> <input
								...
								readonly /><input type="hidden" name="action" value="create" />
							<label for="image_path">Room Image:</label> <input type="file"
								id="image_path" name="image_path" accept="image/*" /> <input
								type="text" name="room_type" value="${room.room_type}" required />
							<input type="text" name="room_description"
								value="${room.room_description}" required /> <input type="text"
								name="room_status" value="${room.room_status}" required /> <input
								type="number" name="room_capacity" value="${room.room_capacity}"
								required /> <input type="text" name="room_furnishing"
							...
							<input type="number" name="room_size" value="${room.room_size}"
								required /> <select name="location_ID" required>
								<c:forEach var="loc" items="${locations}">
