	...
	<div class="Container">
		<div class="left-side">
			...
			<div class="information">
				<p>
					<strong>Address:Kamalpokhari,Kathmandu</strong>
				</p>
				<p>
					<strong>Email:</strong>Roomease20@gmail.com
				</p>
				<p>
					<strong>Phone No:</strong>+9779856321048
				</p>
		...
		<div class="right-side">
			<form method="post"
				...
				<input type="text" name="first_name" placeholder="Full Name"
					...
					name="form_email" placeholder="Email" required>
				<textarea name="form_message" placeholder="Comment or message"
					required></textarea>
