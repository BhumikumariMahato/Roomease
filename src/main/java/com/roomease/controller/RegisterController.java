...
public class RegisterController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			if (isAdded == null) {
				...
				redirectionUtil.setMsgAndRedirect(req, resp, "error", "Your Account Already Exists!",
	...
	private UserModel extractUserModel(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		...
		if (encryptedPassword == null) {
			redirectionUtil.setMsgAndRedirect(req, resp, "error", "Password encryption failed. Please try again.",
					RedirectionUtil.registerUrl);
